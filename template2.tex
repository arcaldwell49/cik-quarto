...
\hypersetup{
  pdftitle={Some Title},
  pdfauthor={Norah Jones; Jon H. Hamm},
...
\title{Some Title}
\author{Norah Jones \and Jon H. Hamm}
\date{2022-08-31}
...
\newpage\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, borderline west={3pt}{0pt}{shadecolor}, breakable, frame hidden, interior hidden, sharp corners, boxrule=0pt]}{\end{tcolorbox}}\fi
