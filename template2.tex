...
%\author{
%% Norah Jones\textsuperscript{1},
%% Jon H. Hamm\textsuperscript{2}%}
...
\affil[3]{University of California - San Diego}
...
\newpage\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, interior hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, sharp corners, frame hidden, enhanced]}{\end{tcolorbox}}\fi
